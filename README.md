## 💫 About Me:
Graduated from Brac University with a CGPA of 4.00 🏆<br>Passionate about developing innovative apps and websites 🖥️<br>Skilled in Python, SQL, PHP, LARAVEL, CSS, HTML, C, LATEX, Assembly, OpenGL, React frontend 🎖️<br> Currently working on NLP, ML, Network Science  📝<br>Expertise in backend development 💡<br>Seeking full-time job opportunities to apply my skills 🏢<br>Satisfaction of creating functional software solutions drew me to CSE 💫
